// This will be a runtime validator
// Somehow adding the background and border color as a comment allows us to dynamically apply these colors in a cn helper function.
